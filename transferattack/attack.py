...
class Attack(object):
    ...
    def load_model(self, model_name):
        ...
        if model_name == "vit_small_patch16_224":
            ...
            if not model_path:
                raise ValueError(
                    "vit_small_patch16_224 requires VIT_SMALL_CHECKPOINT to point to pytorch_model.bin "
                    "or to a directory containing pytorch_model.bin."
                )
